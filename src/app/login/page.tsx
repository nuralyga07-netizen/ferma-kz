    ...
    <div className="min-h-screen flex items-center justify-center relative overflow-hidden pt-20">
      ...
      >
        <div className="glass-card rounded-3xl p-8 sm:p-10">
          ...
          {/* Google Button */}
          <button className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-2xl border border-border hover:bg-muted/50 transition-all text-sm font-medium mb-4">
