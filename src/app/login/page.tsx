        ...
        <div className="glass-card rounded-3xl p-8 sm:p-10">
          ...
          <div className="relative">
            <button
              ...
              className="w-full flex items-center justify-center gap-3 px-6 py-3 rounded-2xl border border-border hover:bg-muted/50 transition-all text-sm font-medium mb-4 opacity-60 cursor-not-allowed"
              disabled
            >
              ...
              Google
              <span className="text-[10px] px-1.5 py-0.5 rounded-md bg-amber-500/10 text-amber-500 font-medium">скоро</span>
            </button>
          </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-11 pr-11 py-3 rounded-2xl border border-border bg-transparent focus:outline-none focus:ring-2 focus:ring-emerald-500/50 text-sm transition-all"
                  required
                />
                <button
                  type="button"
            ...
            <div className="flex items-center justify-between text-sm">
              ...
              <Link href="/forgot-password" className="text-emerald-500 hover:text-emerald-600 transition-colors">
                Забыли пароль?
              </Link>
            </div>
